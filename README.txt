...
First we have prepare(), which using the first argument given to the program will loop through the entirety of the given dictionary file and create a very large 2d array full of words.
